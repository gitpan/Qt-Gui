...
use_ok('Qt::Gui::QX11EmbedContainer');
...
use_ok('Qt::Gui::QX11EmbedWidget');
use_ok('Qt::Gui::QTextList');
use_ok('Qt::Gui::QGestureEvent');
use_ok('Qt::Gui::QDragResponseEvent');
