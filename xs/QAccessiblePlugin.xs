...
MODULE = Qt::Gui			PACKAGE = Qt::Gui::QAccessiblePlugin
PROTOTYPES: DISABLE
...
##  QAccessiblePlugin(QObject * parent = 0)
  void
QAccessiblePlugin::new(...)
PREINIT:
QAccessiblePlugin *ret;
QObject * arg00;
QObject * arg10 = 0;
PPCODE:
    switch(items) {
