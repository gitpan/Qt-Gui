...
PPCODE:
    ...
    ret = new QAccessibleWidget(arg20, arg21, *arg22);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QAccessibleWidget", (void *)ret);
    XSRETURN(1);
    }
	else
    ...
    ret = new QAccessibleWidget(arg10, arg11, *arg12);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QAccessibleWidget", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QAccessibleWidget(arg00, arg01, *arg02);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QAccessibleWidget", (void *)ret);
    XSRETURN(1);
    }
