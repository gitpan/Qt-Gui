...
PPCODE:
    ...
    ret = new QDoubleValidator(arg10);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QDoubleValidator", (void *)ret);
    XSRETURN(1);
    }
        break;
      }
    ...
    ret = new QDoubleValidator(arg00);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QDoubleValidator", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QDoubleValidator(arg20, arg21, arg22, arg23);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QDoubleValidator", (void *)ret);
    XSRETURN(1);
    }
