...
PPCODE:
    ...
    ret = new QFontDialog(arg10);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QFontDialog", (void *)ret);
    XSRETURN(1);
    }
        break;
      }
    ...
    ret = new QFontDialog(*arg30, arg31);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QFontDialog", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QFontDialog(*arg20, arg21);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QFontDialog", (void *)ret);
    XSRETURN(1);
    }
