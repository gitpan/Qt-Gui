...
MODULE = Qt::Gui			PACKAGE = Qt::Gui::QGraphicsEllipseItem
PROTOTYPES: DISABLE
...
##  QGraphicsEllipseItem(QGraphicsItem * parent, QGraphicsScene * scene)
##  QGraphicsEllipseItem(QGraphicsItem * parent, QGraphicsScene * scene = 0)
##  QGraphicsEllipseItem(QGraphicsItem * parent = 0, QGraphicsScene * scene = 0)
##  QGraphicsEllipseItem(const QRectF & rect, QGraphicsItem * parent, QGraphicsScene * scene)
##  QGraphicsEllipseItem(const QRectF & rect, QGraphicsItem * parent, QGraphicsScene * scene = 0)
##  QGraphicsEllipseItem(const QRectF & rect, QGraphicsItem * parent = 0, QGraphicsScene * scene = 0)
##  QGraphicsEllipseItem(qreal x, qreal y, qreal w, qreal h, QGraphicsItem * parent, QGraphicsScene * scene)
##  QGraphicsEllipseItem(qreal x, qreal y, qreal w, qreal h, QGraphicsItem * parent, QGraphicsScene * scene = 0)
...
PPCODE:
    ...
    ret = new QGraphicsEllipseItem(arg20, arg21);
    ST(0) = sv_newmortal();
    ...
    ret = new QGraphicsEllipseItem(arg10, arg11);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsEllipseItem", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QGraphicsEllipseItem(*arg50, arg51, arg52);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsEllipseItem", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QGraphicsEllipseItem(arg00, arg01);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsEllipseItem", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QGraphicsEllipseItem(*arg40, arg41, arg42);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsEllipseItem", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QGraphicsEllipseItem(*arg30, arg31, arg32);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsEllipseItem", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QGraphicsEllipseItem(arg80, arg81, arg82, arg83, arg84, arg85);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsEllipseItem", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QGraphicsEllipseItem(arg70, arg71, arg72, arg73, arg74, arg75);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsEllipseItem", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QGraphicsEllipseItem(arg60, arg61, arg62, arg63, arg64, arg65);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsEllipseItem", (void *)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)QGraphicsEllipseItem::Type);
    XSRETURN(1);
