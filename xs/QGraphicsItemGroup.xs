...
PPCODE:
    ...
    ret = new QGraphicsItemGroup(arg20, arg21);
    ST(0) = sv_newmortal();
    ...
    ret = new QGraphicsItemGroup(arg10, arg11);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsItemGroup", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QGraphicsItemGroup(arg00, arg01);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsItemGroup", (void *)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)QGraphicsItemGroup::Type);
    XSRETURN(1);
