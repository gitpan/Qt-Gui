...
PPCODE:
    ...
    ret = new QGraphicsLinearLayout(arg10);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsLinearLayout", (void *)ret);
    XSRETURN(1);
    }
        break;
      }
    ...
    ret = new QGraphicsLinearLayout(arg00);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsLinearLayout", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QGraphicsLinearLayout(arg30, arg31);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsLinearLayout", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QGraphicsLinearLayout(arg20, arg21);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsLinearLayout", (void *)ret);
    XSRETURN(1);
    }
