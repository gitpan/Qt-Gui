...
MODULE = Qt::Gui			PACKAGE = Qt::Gui::QIconEnginePlugin
PROTOTYPES: DISABLE
...
##  QIconEnginePlugin(QObject * parent = 0)
  void
QIconEnginePlugin::new(...)
PREINIT:
QIconEnginePlugin *ret;
QObject * arg00;
QObject * arg10 = 0;
PPCODE:
    switch(items) {
