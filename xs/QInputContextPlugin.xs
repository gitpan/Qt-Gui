...
MODULE = Qt::Gui			PACKAGE = Qt::Gui::QInputContextPlugin
PROTOTYPES: DISABLE
...
##  QInputContextPlugin(QObject * parent = 0)
  void
QInputContextPlugin::new(...)
PREINIT:
QInputContextPlugin *ret;
QObject * arg00;
QObject * arg10 = 0;
PPCODE:
    switch(items) {
