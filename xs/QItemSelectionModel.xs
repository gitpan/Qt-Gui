...
## QList<QModelIndex> selectedColumns(int row)
## QList<QModelIndex> selectedColumns(int row = 0)
void
...
PPCODE:
    ...
    QList<QModelIndex> ret = THIS->selectedColumns(arg10);
    ST(0) = sv_newmortal();
    ...
    XSRETURN(1);
      ...
      case 2:
      {
        if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    QList<QModelIndex> ret = THIS->selectedColumns(arg00);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::Template::T003", (void *)new QList<QModelIndex>(ret));
    XSRETURN(1);
    }
...
PPCODE:
    ...
    QList<QModelIndex> ret = THIS->selectedIndexes();
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::Template::T003", (void *)new QList<QModelIndex>(ret));
    XSRETURN(1);
    }

## QList<QModelIndex> selectedRows(int column)
## QList<QModelIndex> selectedRows(int column = 0)
void
...
PPCODE:
    ...
    QList<QModelIndex> ret = THIS->selectedRows(arg10);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::Template::T003", (void *)new QList<QModelIndex>(ret));
    XSRETURN(1);
    }
      ...
      case 2:
      {
        if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    QList<QModelIndex> ret = THIS->selectedRows(arg00);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::Template::T003", (void *)new QList<QModelIndex>(ret));
    XSRETURN(1);
    }
