...
PPCODE:
    ...
    ret = new QPushButton(*arg30, arg31);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QPushButton", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QPushButton(*arg20, arg21);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QPushButton", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QPushButton(*arg50, *arg51, arg52);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QPushButton", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QPushButton(*arg40, *arg41, arg42);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QPushButton", (void *)ret);
    XSRETURN(1);
    }
