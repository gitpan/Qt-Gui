...
MODULE = Qt::Gui			PACKAGE = Qt::Gui::QRadioButton
PROTOTYPES: DISABLE
...
PPCODE:
    ...
    ret = new QRadioButton(arg10);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QRadioButton", (void *)ret);
    XSRETURN(1);
    }
        break;
      }
    ...
    ret = new QRadioButton(*arg30, arg31);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QRadioButton", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QRadioButton(*arg20, arg21);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QRadioButton", (void *)ret);
    XSRETURN(1);
    }
