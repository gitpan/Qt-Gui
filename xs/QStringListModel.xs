...
PPCODE:
    ...
    ret = new QStringListModel(arg10);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QStringListModel", (void *)ret);
    XSRETURN(1);
    }
        break;
      }
    ...
    ret = new QStringListModel(arg00);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QStringListModel", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QStringListModel(*arg30, arg31);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QStringListModel", (void *)ret);
    XSRETURN(1);
    }
    ...
    ret = new QStringListModel(*arg20, arg21);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QStringListModel", (void *)ret);
    XSRETURN(1);
    }
