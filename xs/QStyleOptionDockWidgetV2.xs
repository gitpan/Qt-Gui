...
PPCODE:
    ...
    XSRETURN(1);
        ...
        else if (sv_isa(ST(1), "Qt::Gui::QStyleOptionDockWidget")) {
      arg20 = reinterpret_cast<QStyleOptionDockWidget *>(SvIV((SV*)SvRV(ST(1))));
    ret = new QStyleOptionDockWidgetV2(*arg20);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QStyleOptionDockWidgetV2", (void *)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ST(0) = sv_newmortal();
    sv_setiv(ST(0), (IV)QStyleOptionDockWidgetV2::Version);
    XSRETURN(1);
