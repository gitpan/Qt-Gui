...
MODULE = Qt::Gui			PACKAGE = Qt::Gui::Template::T025
PROTOTYPES: DISABLE

# classname: QList<QTableWidgetItem *>
################################################################
#### 
...
PPCODE:
    ...
    ret = new QList<QTableWidgetItem *>();
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::Template::T025", (void *)ret);
    XSRETURN(1);
    }
        break;
      }
      case 2:
      {
        if (sv_isa(ST(1), "Qt::Gui::Template::T025")) {
      arg10 = reinterpret_cast<QList<QTableWidgetItem *> *>(SvIV((SV*)SvRV(ST(1))));
    ret = new QList<QTableWidgetItem *>(*arg10);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::Template::T025", (void *)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ...
    XSRETURN(0);
        ...
        else if (sv_isa(ST(1), "Qt::Gui::Template::T025")) {
      arg10 = reinterpret_cast<QList<QTableWidgetItem *> *>(SvIV((SV*)SvRV(ST(1))));
...
T025::isSharedWith(...)
PREINIT:
QList<QTableWidgetItem *> * arg00;
PPCODE:
    if (sv_isa(ST(1), "Qt::Gui::Template::T025")) {
      arg00 = reinterpret_cast<QList<QTableWidgetItem *> *>(SvIV((SV*)SvRV(ST(1))));
...
PPCODE:
    if (sv_isa(ST(1), "Qt::Gui::Template::T025")) {
      arg00 = reinterpret_cast<QList<QTableWidgetItem *> *>(SvIV((SV*)SvRV(ST(1))));
    QList<QTableWidgetItem *> ret = THIS->operator=(*arg00);
    ST(0) = sv_newmortal();
...
PPCODE:
    if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    QTableWidgetItem * ret = THIS->takeAt(arg00);
    ST(0) = sv_newmortal();
...
PPCODE:
    ...
    QTableWidgetItem * ret = THIS->takeFirst();
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QTableWidgetItem", (void *)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ...
    QTableWidgetItem * ret = THIS->takeLast();
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QTableWidgetItem", (void *)ret);
    XSRETURN(1);
    }
