...
MODULE = Qt::Gui			PACKAGE = Qt::Gui::Template::T039
PROTOTYPES: DISABLE

# classname: QList<QGraphicsView *>
################################################################
#### 
...
T039::new(...)
PREINIT:
QList<QGraphicsView *> *ret;
QList<QGraphicsView *> * arg10;
PPCODE:
    switch(items) {
      case 1:
      {
    ...
    ret = new QList<QGraphicsView *>();
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::Template::T039", (void *)ret);
    XSRETURN(1);
    }
        break;
      }
      case 2:
      {
        if (sv_isa(ST(1), "Qt::Gui::Template::T039")) {
      arg10 = reinterpret_cast<QList<QGraphicsView *> *>(SvIV((SV*)SvRV(ST(1))));
    ret = new QList<QGraphicsView *>(*arg10);
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::Template::T039", (void *)ret);
    XSRETURN(1);
    }
...
PPCODE:
    switch(items) {
      ...
      {
        if (sv_isa(ST(1), "")) {
      arg00 = reinterpret_cast<QGraphicsView * *>(SvIV((SV*)SvRV(ST(1))));
    (void)THIS->append(*arg00);
    XSRETURN(0);
    }
        else if (sv_isa(ST(1), "Qt::Gui::Template::T039")) {
      arg10 = reinterpret_cast<QList<QGraphicsView *> *>(SvIV((SV*)SvRV(ST(1))));
...
PPCODE:
    switch(items) {
      ...
      {
        if (sv_isa(ST(1), "")) {
      arg10 = reinterpret_cast<QGraphicsView * *>(SvIV((SV*)SvRV(ST(1))));
...
PPCODE:
    if (SvIOK(ST(1)) && sv_isa(ST(2), "")) {
      arg00 = (int)SvIV(ST(1));
      arg01 = reinterpret_cast<QGraphicsView * *>(SvIV((SV*)SvRV(ST(2))));
...
T039::isSharedWith(...)
PREINIT:
QList<QGraphicsView *> * arg00;
PPCODE:
    if (sv_isa(ST(1), "Qt::Gui::Template::T039")) {
      arg00 = reinterpret_cast<QList<QGraphicsView *> *>(SvIV((SV*)SvRV(ST(1))));
...
void
T039::operator_assign(...)
PREINIT:
QList<QGraphicsView *> * arg00;
PPCODE:
    if (sv_isa(ST(1), "Qt::Gui::Template::T039")) {
      arg00 = reinterpret_cast<QList<QGraphicsView *> *>(SvIV((SV*)SvRV(ST(1))));
    QList<QGraphicsView *> ret = THIS->operator=(*arg00);
    ST(0) = sv_newmortal();
...
PPCODE:
    if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    QGraphicsView * * ret = &THIS->operator[](arg00);
    ST(0) = sv_newmortal();
...
PPCODE:
    if (SvIOK(ST(1))) {
      arg00 = (int)SvIV(ST(1));
    QGraphicsView * ret = THIS->takeAt(arg00);
    ST(0) = sv_newmortal();
...
PPCODE:
    ...
    QGraphicsView * ret = THIS->takeFirst();
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsView", (void *)ret);
    XSRETURN(1);
    }
...
PPCODE:
    ...
    QGraphicsView * ret = THIS->takeLast();
    ST(0) = sv_newmortal();
    sv_setref_pv(ST(0), "Qt::Gui::QGraphicsView", (void *)ret);
    XSRETURN(1);
    }
